    ...
    <section className="py-24 lg:py-32 bg-card/50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <Link
            href="/portfolio"
            className="inline-flex items-center gap-2 text-[#00D2FF] font-medium hover:gap-3 transition-all shrink-0"
          >
            View All Projects
              ...
              >
                <div className="relative h-full rounded-2xl overflow-hidden bg-card border border-border hover:border-[#00D2FF]/30 transition-all duration-500">
                  ...
                  <div className="p-6">
                    ...
                    {/* Title */}
                    <h3 className="text-xl font-bold mb-3 group-hover:text-[#00D2FF] transition-colors">
                      {study.title}
                    </h3>
